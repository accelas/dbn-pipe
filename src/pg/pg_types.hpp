...
struct Timestamptz {
    ...
    // Encode from unix nanoseconds (dbn_pipe::TimestampCol::cpp_type)
...
template <> struct PgTypeFor<dbn_pipe::TimestampCol> { using type = Timestamptz; static constexpr const char* name() { return "TIMESTAMPTZ"; } };
